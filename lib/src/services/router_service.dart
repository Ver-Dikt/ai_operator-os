...
class RouterService {
  ...
  RoutePlan _videoRoute(String task) {
    return RoutePlan(
      ...
      tools: const ['Kling', 'Veo', 'Runway', 'Higgsfield', 'Pika', 'Luma'],
      toolIds: const ['kling', 'veo', 'runway', 'higgsfield', 'pika', 'luma'],
      agents: const [
  ...
  RoutePlan _musicRoute(String task) {
    return RoutePlan(
      ...
      tools: const ['Suno', 'Udio', 'ElevenLabs'],
      toolIds: const ['suno', 'udio', 'elevenlabs'],
      agents: const [
